...
import 'package:ecommerce_admin_app/container/additional_confirm.dart';
    ...
    return Scaffold(
      ...
      body: Consumer<AdminProvider>(builder: (context, value, child) {
        ...
        if (value.categories.isEmpty) {
          return Center(
            child: Text('No Categorties Found'),
          );
        }
          ...
          itemBuilder: (context, index) {
            return ListTile(
              ...
              onTap: (){
                ...
                AlertDialog(
                  title: Text('Choose What you want to do'),
                  content: Text('Delete action cannnot be undone'),
                    ...
                    TextButton(onPressed: (){
                      ...
                      showDialog(
                          ...
                          builder: (context) => ModifyCategory(
                            ...
                            image: categories[index].image,name: categories[index].name,));
              ...
              subtitle: Text('Pirority : ${categories[index].priority}'),
              trailing: IconButton(
...
class _ModifyCategoryState extends State<ModifyCategory> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(widget.isUpdating ? "Updated category" : "Add category"),
      content: SingleChildScrollView(
        child: Form(
            ...
            child: Column(
              ...
              children: [
                Text("All Will be converted be lowercase"),
                SizedBox(
                  height: 10,
                ),
                TextFormField(
      ...
      actions: [
        ...
        TextButton(
            ...
            child: Text(widget.isUpdating ? "Updates" : "Add"))
      ],
    );
  }
}
